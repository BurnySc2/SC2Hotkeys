...
if platform.system() == "Linux":
    ...
    normal_folder = Path("/media/ssd250/Games/starcraft5/drive_c/users/burny/Documents/StarCraft II/Hotkeys/")
    accounts_folder = Path("/media/ssd250/Games/starcraft5/drive_c/users/burny/Documents/StarCraft II/Accounts/")
# Windows
else:
